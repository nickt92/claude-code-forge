...
Analyzes your existing codebase and launches an interactive Claude
session to generate a comprehensive project-level CLAUDE.md.
...
banner "Project CLAUDE.md Generator"
echo ""
info "Project: ${PROJECT_NAME}"
info "Path:    ${PROJECT_DIR}"

# ── Gather codebase context ─────────────────────────────────
step "Gathering codebase context"
...
ok "$context_lines lines ($((context_size / 1024))KB) of context gathered"
...
info "Review and iterate until satisfied."
echo ""
