...
**`forge` CLI** · **Desktop App (Beta)** · **12 Personas** · **3 Plugin Groups** · **3 Permission Presets** · **9 Hooks** · **8 Rules Files** · **1,009 Tests**
...
### 1,009 Tests
820 CLI (bats-core) + 189 Swift, cross-platform on every push via GitHub Actions.
...
1,009 automated tests across two suites, run on every push via GitHub Actions —
including release branches, and including the Swift suite.

**CLI (bats-core)** | 820 tests across macOS, Ubuntu, and Windows:
