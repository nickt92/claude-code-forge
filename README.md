...
[![Version](https://img.shields.io/badge/version-1.5.1-brightgreen?style=flat-square)](https://github.com/nickt92/claude-code-forge/releases)
...
**`forge` CLI** · **Desktop App (Beta)** · **12 Personas** · **3 Plugin Groups** · **3 Permission Presets** · **9 Hooks** · **8 Rules Files** · **1,031 Tests**
...
### 1,031 Tests
842 CLI (bats-core) + 189 Swift, cross-platform on every push via GitHub Actions.
...
1,031 automated tests across two suites, run on every push via GitHub Actions —
including release branches, and including the Swift suite.

**CLI (bats-core)** | 842 tests across macOS, Ubuntu, and Windows:
...
| Suite | Files | Covers |
|:------|------:|:-------|
| **Unit** | 32 | Hooks, CLI, plugins, manifest, platform, UI, config, dashboard, stats (incl. JSON), export, permissions, audit |
| **Integration** | 14 | Assembly, settings merge/unmerge, install, backup/restore, switch, doctor, diff, update, build, init, permissions CLI |
